...
/// @notice Deploys the token, seats DEFAULT_ADMIN_ROLE / OPERATOR_ROLE through
...
abstract contract BaseTest is Test {
    ...
    event Retracted(address indexed burnedBy, address indexed from, uint256 amount);
    ...
    function setUp() public virtual {
        ...
        OPERATOR_ROLE = token.OPERATOR_ROLE();
